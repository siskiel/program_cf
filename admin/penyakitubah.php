...
<div class="pull-right">
    <a href="index.php?halaman=penyakit" class="btn-warning btn">
        << Kembali </a>
</div>
<br>
<br>
...
<form method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label>Solusi</label>
        <textarea type="text" class="form-control" name="solusi" rows="10"><?php echo $pecah['solusi']; ?>
        </textarea>
    </div>
...
if (isset($_POST['ubah'])) {
    ...
    $koneksi->query("UPDATE penyakit SET nama_penyakit='$_POST[nama]',solusi='$_POST[solusi]' WHERE id_penyakit='$_GET[id]'");
